...
const news1 = document.querySelector('.news--sm');
const news2 = document.querySelector('.news--big');
const rules = document.querySelector('.rules');
const winners1 = document.querySelector('.winners--sm');
const winners2 = document.querySelector('.winners--big');
